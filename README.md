...
Gram is a lightweight Zig library with a single purpose: generate a Zig module
for your resources or assets. It's so lightweight in fact, that it exists
entirely within the `build.zig`.
...
This will add `assets.zig` to your `assets` directory
...
```zig
// Generated by `gram` — do not edit.

pub const fonts = struct {
    pub const @"summer-fav.ttf": []const u8 = @embedFile("fonts/summer-fav.ttf");
    pub const @"super-pixel.ttf": []const u8 = @embedFile("fonts/super-pixel.ttf");
    pub const @"supreme-spike.otf": []const u8 = @embedFile("fonts/supreme-spike.otf");
    pub const @"techno-race-italic.otf": []const u8 = @embedFile("fonts/techno-race-italic.otf");
};
```
